          ...
          <div className="flex gap-3">
            {[
              ...
              <a key={s.label} href="#" aria-label={s.label}
                className="flex h-9 w-9 items-center justify-center rounded-lg border border-surface-800 text-surface-500 transition-all hover:border-cyan-500/30 hover:text-cyan-400">
                {s.icon}
              </a>
            ))}
          </div>
