import { ArrowRight, Play, Star, Users, Globe, Sparkles } from "lucide-react";
    ...
    <section className="relative overflow-hidden pt-28 pb-20 sm:pt-36 sm:pb-28">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          {/* Headline */}
          <h1 className="mb-6 text-4xl leading-tight font-extrabold tracking-tight text-surface-900 sm:text-5xl md:text-6xl lg:text-7xl dark:text-white">
            Tu Web Profesional.{" "}
          ...
          {/* Subtitle */}
          <p className="mx-auto mb-10 max-w-2xl text-lg leading-relaxed text-surface-600 sm:text-xl dark:text-surface-400">
          ...
          {/* How it works mini */}
          <a href="#como-funciona" className="mt-6 inline-flex items-center gap-2 text-sm font-medium text-surface-500 transition-colors hover:text-primary-500 dark:text-surface-400">
          ...
          <div className="mt-14 flex flex-col items-center justify-center gap-8 sm:flex-row sm:gap-12">
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-primary-100 dark:bg-primary-500/10">
                <Users className="h-5 w-5 text-primary-600 dark:text-primary-400" />
              </div>
              <div className="text-left">
                <p className="text-2xl font-bold text-surface-900 dark:text-white">200+</p>
                <p className="text-sm text-surface-500 dark:text-surface-400">Negocios activos</p>
              </div>
            </div>
